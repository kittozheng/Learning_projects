...
// 	{
// 		return \view::make('admin.pages.show')->with('pages', Page::find($id))->withAuthor(Sentry::findUserById(Page::find($id)->user_id)->name);
// 	}
...
// 	{
// 		return \View::make('admin.pages.edit')->with('pages', Page::find($id));
// 	}
